(function (scope) {
    ...
    */
    ...
    var $author$project$Note$a1 = _List_fromArray([$author$project$Note$A1]);
    var $author$project$Note$A2 = { $: 'A2' };
    var $author$project$Note$a2 = _List_fromArray([$author$project$Note$A2]);
    var $author$project$Note$B1 = { $: 'B1' };
    var $author$project$Note$b1 = _List_fromArray([$author$project$Note$B1]);
    var $author$project$Config$beatsPerBar = 8;
    var $author$project$Note$bar = function (list) {
        return (_Utils_cmp($elm$core$List$length(list), $author$project$Config$beatsPerBar) < 0) ? $author$project$Note$bar(A2($elm$core$List$concatMap, function (l) {
            return _List_fromArray([l, _List_Nil]);
        }, list)) : list;
    };
    var $author$project$Note$C1 = { $: 'C1' };
    var $author$project$Note$c1 = _List_fromArray([$author$project$Note$C1]);
    var $author$project$Note$C2 = { $: 'C2' };
    var $author$project$Note$c2 = _List_fromArray([$author$project$Note$C2]);
    var $author$project$Note$C3 = { $: 'C3' };
    var $author$project$Note$c3 = _List_fromArray([$author$project$Note$C3]);
    var $author$project$Note$D1 = { $: 'D1' };
    var $author$project$Note$d1 = _List_fromArray([$author$project$Note$D1]);
    var $author$project$Note$D2 = { $: 'D2' };
    var $author$project$Note$d2 = _List_fromArray([$author$project$Note$D2]);
    var $author$project$Note$E1 = { $: 'E1' };
    var $author$project$Note$e1 = _List_fromArray([$author$project$Note$E1]);
    var $author$project$Note$E2 = { $: 'E2' };
    var $author$project$Note$e2 = _List_fromArray([$author$project$Note$E2]);
    var $author$project$Note$F1 = { $: 'F1' };
    var $author$project$Note$f1 = _List_fromArray([$author$project$Note$F1]);
    var $author$project$Note$F2 = { $: 'F2' };
    var $author$project$Note$f2 = _List_fromArray([$author$project$Note$F2]);
    ...
    var $author$project$Note$g1 = _List_fromArray([$author$project$Note$G1]);
    var $author$project$Note$G2 = { $: 'G2' };
    var $author$project$Note$g2 = _List_fromArray([$author$project$Note$G2]);
    ...
    var $author$project$Song$default = function () {
        var part4 = _List_fromArray([
            $author$project$Note$bar(_List_fromArray([
                ...
                _Utils_ap($author$project$Note$c1, _Utils_ap($author$project$Note$c2, $author$project$Note$g1))
            ])),
            $author$project$Note$bar(_List_fromArray([
                _Utils_ap($author$project$Note$a1, $author$project$Note$a2),
                _Utils_ap($author$project$Note$f1, _Utils_ap($author$project$Note$f2, $author$project$Note$c2)),
                _Utils_ap($author$project$Note$d2, $author$project$Note$d1),
                _Utils_ap($author$project$Note$c2, _Utils_ap($author$project$Note$c1, $author$project$Note$c3))
            ]))
        ]);
        var part3 = _List_fromArray([
            $author$project$Note$bar(_List_fromArray([
                _Utils_ap($author$project$Note$c2, _Utils_ap($author$project$Note$e1, $author$project$Note$g1)),
                $author$project$Note$d2,
                _Utils_ap($author$project$Note$a2, _Utils_ap($author$project$Note$c2, $author$project$Note$f2)),
                $author$project$Note$pause,
                _Utils_ap($author$project$Note$f2, _Utils_ap($author$project$Note$a1, $author$project$Note$c2)),
                $author$project$Note$g2,
                _Utils_ap($author$project$Note$e1, _Utils_ap($author$project$Note$g1, $author$project$Note$c2)),
                $author$project$Note$pause
            ])),
            $author$project$Note$bar(_List_fromArray([
                _Utils_ap($author$project$Note$c2, _Utils_ap($author$project$Note$e2, $author$project$Note$g2)),
                $author$project$Note$g1,
                _Utils_ap($author$project$Note$a1, _Utils_ap($author$project$Note$c2, $author$project$Note$f2)),
                $author$project$Note$pause,
                _Utils_ap($author$project$Note$f1, _Utils_ap($author$project$Note$a1, $author$project$Note$c1)),
                $author$project$Note$e1,
                _Utils_ap($author$project$Note$d2, _Utils_ap($author$project$Note$b1, $author$project$Note$g1)),
        ...
        return $elm$core$Dict$fromList(_List_fromArray([
            _Utils_Tuple2($author$project$Song$lilyPadInstrument, $elm$core$Array$fromList(_Utils_ap(_List_fromArray([$author$project$Note$c2, $author$project$Note$pause]), _Utils_ap($elm$core$List$concat(A2($elm$core$List$repeat, 1, $elm$core$List$concat($elm$core$List$concat(_List_fromArray([part1, part2, part1, part3, part4, part2, part4, part3]))))), _List_fromArray([
                _Utils_ap($author$project$Note$c2, _Utils_ap($author$project$Note$c1, $author$project$Note$c3))
            ])))))
        ]));
    }();
    ...
    var $author$project$Game$new = function () {
        ...
        var objects = $elm$core$Dict$fromList(A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, A2($elm$core$List$concatMap, function (_v3) {
            var instrument = _v3.a;
            var array = _v3.b;
            return $elm$core$List$concat(A2($elm$core$List$filterMap, $elm$core$Basics$identity, $elm$core$Array$toList(A2($elm$core$Array$indexedMap, F2(function (j, list) {
                return A2($elm$core$Maybe$map, function (sort) {
                    return A2($elm$core$List$map, function (note) {
                        return { note: note, sort: sort, start: j };
                    }, list);
                }, _Utils_eq(instrument, $author$project$Song$lilyPadInstrument) ? $elm$core$Maybe$Just($author$project$Game$LilyPad({ active: !j })) : (_Utils_eq(instrument, $author$project$Song$waveInstrument) ? $elm$core$Maybe$Just($author$project$Game$Wave) : $elm$core$Maybe$Nothing));
            }), array))));
        }, $elm$core$Dict$toList(track))));
        var bpm = $author$project$Config$minBpm;
        var statistics = { maxBpm: bpm, stops: 0 };
        var _v0 = A3($elm$core$Dict$foldl, F3(function (id, _v1, _v2) {
            var start = _v1.start;
            var d = _v2.a;
            var e = _v2.b;
            return _Utils_Tuple2(A3($elm$core$Dict$update, start, function (maybe) {
                return $elm$core$Maybe$Just(A2($elm$core$List$cons, id, A2($elm$core$Maybe$withDefault, _List_Nil, maybe)));
            }, d), A2($elm$core$Basics$max, e, start));
        }), _Utils_Tuple2($elm$core$Dict$empty, 0), objects);
        var rows = _v0.a;
    ...
    var $author$project$Main$init = function (_v0) {
        return _Utils_Tuple2({ game: $author$project$Game$new, isMuted: false, msSinceLastBeat: 0, showSettings: false, showTitle: true, volume: 0 }, $elm$core$Platform$Cmd$none);
    };
    var $author$project$Main$NextFrameRequested = function (a) {
        return { $: 'NextFrameRequested', a: a };
    };
    ...
    var $elm$browser$Browser$AnimationManager$onEffects = F3(function (router, subs, _v0) {
        ...
        if (_v1.a.$ === 'Nothing') {
            ...
            if (!_v1.b.b) {
                ...
                return $elm$core$Task$succeed(A3($elm$browser$Browser$AnimationManager$State, subs, request, oldTime));
            }
        }
    });
    ...
    var $author$project$Main$subscriptions = function (model) {
        return (model.showTitle || model.showSettings) ? $elm$core$Platform$Sub$none : (model.game.running ? $elm$core$Platform$Sub$batch(_List_fromArray([
            $elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Main$NextFrameRequested)
        ])) : $elm$core$Platform$Sub$none);
    };
    var $author$project$Game$activatePlatform = F2(function (id, game) {
        return _Utils_update(game, {
            objects: A3($elm$core$Dict$update, id, $elm$core$Maybe$map(function (platform) {
                var _v0 = platform.sort;
                if (_v0.$ === 'LilyPad') {
                    var lilyPad = _v0.a;
                    return _Utils_update(platform, {
                        sort: $author$project$Game$LilyPad(_Utils_update(lilyPad, { active: true }))
                    });
                }
                else {
                    return platform;
    ...
    var $author$project$Game$getNextPossibleLilyPads = F2(function (game, from) {
        return A2($elm$core$List$filterMap, function (next) {
            return A2($elm$core$Maybe$andThen, function (object) {
                var _v0 = object.sort;
                if (_v0.$ === 'LilyPad') {
                    var active = _v0.a.active;
                    return active ? $elm$core$Maybe$Just(_Utils_Tuple2(next, object)) : $elm$core$Maybe$Nothing;
                }
                else {
                    return $elm$core$Maybe$Nothing;
                }
            }, A2($elm$core$Dict$get, next, game.objects));
        }, A2($elm$core$Maybe$withDefault, _List_Nil, A2($elm$core$Maybe$map, function (y) {
            return A2($elm$core$List$concatMap, function (amount) {
                return A2($elm$core$Maybe$withDefault, _List_Nil, A2($elm$core$Dict$get, y + amount, game.rows));
    ...
    var $author$project$Game$nextPlayerPos = function (game) {
        ...
        return A2($elm$core$Maybe$withDefault, _Utils_update(game, {
            ...
            statistics: function (statistics) {
                return _Utils_update(statistics, { stops: statistics.stops + 1 });
            }(game.statistics)
        }), A2($elm$core$Maybe$map, function (_v0) {
            var next = _v0.a;
            var object = _v0.b;
            return _Utils_eq(object.start - 1, game.songPosition) ? _Utils_update(game, {
                player: $author$project$Game$Jumping({ from: currentObjectId, to: next })
            }) : _Utils_update(game, {
                player: $author$project$Game$OnPlatform(currentObjectId)
            });
        }, $elm$core$List$head(A2($author$project$Game$getNextPossibleLilyPads, game, currentObjectId))));
    };
    var $author$project$Game$nextBeat = function (game) {
        ...
        return _Utils_Tuple2($author$project$Game$nextPlayerPos(_Utils_update(game, {
            bpm: bpm,
            songPosition: songPosition,
            statistics: function (statistics) {
                return _Utils_update(statistics, {
                    maxBpm: A2($elm$core$Basics$max, game.statistics.maxBpm, bpm)
                });
            }(game.statistics)
        })), A3($elm$core$List$foldl, function (_v0) {
            var note = _v0.note;
            var sort = _v0.sort;
            if (sort.$ === 'LilyPad') {
                var active = sort.a.active;
                return active ? A2($elm$core$Dict$update, $author$project$Song$lilyPadInstrument, function (maybe) {
                    return $elm$core$Maybe$Just(A2($elm$core$List$cons, note, A2($elm$core$Maybe$withDefault, _List_Nil, maybe)));
                }) : $elm$core$Basics$identity;
            }
            else {
                return A2($elm$core$Dict$update, $author$project$Song$waveInstrument, function (maybe) {
                    return $elm$core$Maybe$Just(A2($elm$core$List$cons, note, A2($elm$core$Maybe$withDefault, _List_Nil, maybe)));
                });
            }
        }, $elm$core$Dict$empty, A2($elm$core$List$filterMap, function (id) {
            return A2($elm$core$Dict$get, id, game.objects);
        }, A2($elm$core$Maybe$withDefault, _List_Nil, A2($elm$core$Dict$get, songPosition, game.rows)))));
    };
    ...
    var $author$project$Port$playSound = F2(function (instrument, notes) {
        return $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2('name', $elm$json$Json$Encode$string('playSound')),
            _Utils_Tuple2('sound', A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, A2($elm$core$List$map, $author$project$Note$toString, notes))),
            _Utils_Tuple2('instrument', $elm$json$Json$Encode$string(instrument))
        ]));
    });
    ...
    var $author$project$Game$recheckNextPlayerPos = function (game) {
        ...
        if (_v0.$ === 'OnPlatform') {
            var platformId = _v0.a;
            return (!_Utils_eq(A2($author$project$Game$getNextPossibleLilyPads, game, platformId), _List_Nil)) ? $author$project$Game$nextPlayerPos(_Utils_update(game, { running: true })) : game;
        }
        else {
            return game;
        }
    ...
    var $author$project$Port$setVolume = function (amount) {
        return $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2('name', $elm$json$Json$Encode$string('setVolume')),
            _Utils_Tuple2('amount', $elm$json$Json$Encode$float(amount))
        ]));
    };
    var $author$project$Port$toggleMute = $elm$json$Json$Encode$object(_List_fromArray([
        _Utils_Tuple2('name', $elm$json$Json$Encode$string('toggleMute'))
    ]));
        ...
        switch (msg.$) {
            case 'NextFrameRequested':
                ...
                return (_Utils_cmp(msSinceLastBeat, maxDelta) > -1) ? function (_v1) {
                    var game = _v1.a;
                    var dict = _v1.b;
                    return _Utils_Tuple2(_Utils_update(model, { game: game, msSinceLastBeat: msSinceLastBeat - maxDelta }), $elm$core$Platform$Cmd$batch(A2($elm$core$List$map, function (_v2) {
                        var instrument = _v2.a;
                        var notes = _v2.b;
                        return $author$project$Main$send(A2($author$project$Port$playSound, instrument, notes));
                    }, $elm$core$Dict$toList(dict))));
                }($author$project$Game$nextBeat(model.game)) : _Utils_Tuple2(_Utils_update(model, { msSinceLastBeat: msSinceLastBeat }), $elm$core$Platform$Cmd$none);
            case 'ActivatePlatform':
                var platformId = msg.a;
                return _Utils_Tuple2(_Utils_update(model, {
                    game: $author$project$Game$recheckNextPlayerPos(A2($author$project$Game$activatePlatform, platformId, model.game))
                }), $elm$core$Platform$Cmd$none);
            case 'ToggleSettings':
                return _Utils_Tuple2(_Utils_update(model, { showSettings: !model.showSettings }), $elm$core$Platform$Cmd$none);
            case 'StartGame':
                return _Utils_Tuple2(_Utils_update(model, { game: $author$project$Game$new, msSinceLastBeat: 0, showTitle: false }), $elm$core$Platform$Cmd$none);
            case 'SetVolume':
                var amount = msg.a;
                return _Utils_Tuple2(_Utils_update(model, { volume: amount }), $author$project$Main$send($author$project$Port$setVolume(amount)));
            default:
                return _Utils_Tuple2(_Utils_update(model, { isMuted: !model.isMuted }), $author$project$Main$send($author$project$Port$toggleMute));
        }
    });
    ...
    var $author$project$Main$calcRatioToNextBeat = F2(function (args, game) {
    ...
    var $author$project$View$Common$calcLilyPadPosition = function (args) {
        ...
        return _Utils_Tuple2($author$project$Config$horizontalSpaceBetweenPlatforms * $author$project$Note$toInt(args.note), (($author$project$Config$verticalSpaceBetweenPlatforms * (((-args.start) + ratio) + args.beatsPlayed)) + $author$project$Config$screenHeight) - ($author$project$Config$lilyPadSize * 2));
    };
    var $author$project$Config$playerSize = 60;
    var $author$project$View$calcPlayerPositionOnPlatform = F2(function (args, _v0) {
        var note = _v0.a;
        var start = _v0.b;
        var _v1 = $author$project$View$Common$calcLilyPadPosition({ beatsPlayed: args.beatsPlayed, note: note, ratioToNextBeat: args.ratioToNextBeat, start: start });
        var x = _v1.a;
        var y = _v1.b;
    ...
    var $author$project$View$calcPlayerJumpingPosition = function (args) {
        ...
        var calcPosition = $author$project$View$calcPlayerPositionOnPlatform({ beatsPlayed: args.beatsPlayed, ratioToNextBeat: args.ratioToNextBeat });
        var _v0 = calcPosition(args.from);
        var x2 = _v0.a;
        var y2 = _v0.b;
        var _v1 = calcPosition(args.to);
        var x1 = _v1.a;
        var y1 = _v1.b;
    ...
    var $Orasund$elm_layout$Layout$column = function (attrs) {
        return $elm$html$Html$div(_Utils_ap(_List_fromArray([
    ...
    var $Orasund$elm_layout$Layout$el = F2(function (attrs, content) {
        return A2($elm$html$Html$div, A2($elm$core$List$cons, A2($elm$html$Html$Attributes$style, 'display', 'flex'), attrs), _List_fromArray([content]));
    });
    ...
    var $Orasund$elm_layout$Layout$gap = function (n) {
        return A2($elm$html$Html$Attributes$style, 'gap', $elm$core$String$fromFloat(n) + 'px');
    };
    var $elm$html$Html$h2 = _VirtualDom_node('h2');
    var $Orasund$elm_layout$Layout$heading2 = F2(function (attrs, content) {
        return A2($elm$html$Html$h2, A2($elm$core$List$cons, A2($elm$html$Html$Attributes$style, 'display', 'flex'), attrs), _List_fromArray([content]));
    });
    ...
    var $Orasund$elm_layout$Layout$text = F2(function (attrs, content) {
        return A2($Orasund$elm_layout$Layout$el, attrs, $elm$html$Html$text(content));
    });
    ...
    var $Orasund$elm_layout$Layout$asButton = function (args) {
        ...
        ]), A2($elm$core$Maybe$withDefault, _List_Nil, A2($elm$core$Maybe$map, function (msg) {
    ...
    var $Orasund$elm_layout$Layout$textButton = F2(function (attrs, args) {
        return A2($elm$html$Html$button, _Utils_ap($Orasund$elm_layout$Layout$asButton(args), attrs), _List_fromArray([
            $elm$html$Html$text(args.label)
        ]));
    });
    var $author$project$View$endgame = F2(function (args, game) {
        return A2($Orasund$elm_layout$Layout$el, _List_fromArray([
            A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
            A2($elm$html$Html$Attributes$style, 'top', $elm$core$String$fromFloat($author$project$Config$lilyPadSize) + 'px'),
        ...
        ]), A2($Orasund$elm_layout$Layout$column, _List_fromArray([
            $Orasund$elm_layout$Layout$gap(8)
        ]), _List_fromArray([
            A2($Orasund$elm_layout$Layout$heading2, _List_fromArray([
                A2($elm$html$Html$Attributes$style, 'color', $author$project$Config$playerColor)
            ]), $elm$html$Html$text('Thanks for Playing')),
            A2($Orasund$elm_layout$Layout$text, _List_Nil, 'Max Bpm: ' + $elm$core$String$fromFloat(function (f) {
                return f / 100;
            }($elm$core$Basics$round(game.statistics.maxBpm * 100)))),
            A2($Orasund$elm_layout$Layout$text, _List_Nil, 'Stops: ' + $elm$core$String$fromInt(game.statistics.stops)),
            A2($Orasund$elm_layout$Layout$text, _List_Nil, 'Notes missed: ' + $elm$core$String$fromInt($elm$core$Dict$size(A2($elm$core$Dict$filter, F2(function (_v0, object) {
                var _v1 = object.sort;
                if (_v1.$ === 'LilyPad') {
            ...
            A2($Orasund$elm_layout$Layout$textButton, _List_fromArray([
    ...
    var $author$project$View$Object$lilyPad = F2(function (args, _v0) {
        var x = _v0.a;
        var y = _v0.b;
        var lilyPadSize = args.size * $author$project$Config$lilyPadSize;
        var offSet = ($author$project$Config$lilyPadSize / 2) - (lilyPadSize / 2);
        return A2($elm$html$Html$button, _Utils_ap(_List_fromArray([
            A2($elm$html$Html$Attributes$style, 'width', $elm$core$String$fromFloat(lilyPadSize) + 'px'),
            A2($elm$html$Html$Attributes$style, 'height', $elm$core$String$fromFloat(lilyPadSize) + 'px'),
            A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
            A2($elm$html$Html$Attributes$style, 'border-radius', '100%'),
            A2($elm$html$Html$Attributes$style, 'top', $elm$core$String$fromFloat(y + offSet) + 'px'),
            A2($elm$html$Html$Attributes$style, 'left', $elm$core$String$fromFloat(x + offSet) + 'px'),
    ...
    var $author$project$View$Object$wave = function (_v0) {
        ...
        return A2($elm$html$Html$div, _List_fromArray([
            A2($elm$html$Html$Attributes$style, 'width', $elm$core$String$fromFloat($author$project$Config$lilyPadSize) + 'px'),
            A2($elm$html$Html$Attributes$style, 'height', $elm$core$String$fromFloat($author$project$Config$lilyPadSize) + 'px'),
            A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
            A2($elm$html$Html$Attributes$style, 'top', $elm$core$String$fromFloat(y) + 'px'),
            A2($elm$html$Html$Attributes$style, 'left', $elm$core$String$fromFloat(x) + 'px'),
            A2($elm$html$Html$Attributes$style, 'background-color', 'black')
        ]), _List_Nil);
    };
    var $author$project$View$Object$fromDict = F2(function (args, dict) {
        return A2($elm$core$List$map, function (_v0) {
            ...
            }()($author$project$View$Common$calcLilyPadPosition({ beatsPlayed: args.beatsPlayed, note: note, ratioToNextBeat: args.ratioToNextBeat, start: start }));
        }, $elm$core$Dict$toList(dict));
    });
    ...
    var $author$project$View$player = function (_v0) {
        ...
        return A2($elm$html$Html$img, _List_fromArray([
            A2($elm$html$Html$Attributes$style, 'width', $elm$core$String$fromFloat($author$project$Config$playerSize) + 'px'),
            A2($elm$html$Html$Attributes$style, 'height', $elm$core$String$fromFloat($author$project$Config$playerSize) + 'px'),
            A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
            A2($elm$html$Html$Attributes$style, 'top', $elm$core$String$fromFloat(y) + 'px'),
            A2($elm$html$Html$Attributes$style, 'left', $elm$core$String$fromFloat(x) + 'px'),
            $elm$html$Html$Attributes$src('assets/images/frog.png'),
            A2($elm$html$Html$Attributes$style, 'z-index', $elm$core$String$fromInt($author$project$Config$playerZIndex))
        ]), _List_Nil);
    };
    var $author$project$View$settingsButton = function (args) {
        return A2($Orasund$elm_layout$Layout$textButton, _List_fromArray([
            A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
    ...
    var $author$project$View$fromGame = F2(function (args, game) {
        var getPlatformPosition = function (id) {
            return A2($elm$core$Maybe$withDefault, _Utils_Tuple2($author$project$Note$bang, 0), A2($elm$core$Maybe$map, function (_v1) {
                var start = _v1.start;
                var note = _v1.note;
        ...
        var playerPos = function () {
            ...
            if (_v0.$ === 'OnPlatform') {
                var id = _v0.a;
                return A2($author$project$View$calcPlayerPositionOnPlatform, { beatsPlayed: game.songPosition, ratioToNextBeat: args.ratioToNextBeat }, getPlatformPosition(id));
            }
            else {
                var from = _v0.a.from;
                var to = _v0.a.to;
        ...
        return A2($elm$html$Html$div, _List_fromArray([
            ...
            A2($elm$html$Html$Attributes$style, 'height', $elm$core$String$fromFloat($author$project$Config$screenHeight) + 'px'),
            A2($elm$html$Html$Attributes$style, 'width', $elm$core$String$fromFloat($author$project$Config$screenWidth) + 'px'),
            A2($elm$html$Html$Attributes$style, 'overflow', 'hidden')
        ]), $elm$core$List$concat(_List_fromArray([
            A2($author$project$View$Object$fromDict, { beatsPlayed: game.songPosition, onClick: args.onClick, ratioToNextBeat: args.ratioToNextBeat }, game.objects),
            _Utils_eq(game.songPosition, game.endPosition) ? _List_fromArray([
                A2($author$project$View$endgame, { start: args.start }, game)
            ]) : _List_Nil,
            _List_fromArray([
                $author$project$View$player(playerPos),
                $author$project$View$settingsButton({ onClick: args.toggleSettings })
            ])
        ])));
    });
    var $Orasund$elm_layout$Layout$alignAtCenter = A2($elm$html$Html$Attributes$style, 'align-items', 'center');
    var $Orasund$elm_layout$Layout$centered = _List_fromArray([$Orasund$elm_layout$Layout$contentCentered, $Orasund$elm_layout$Layout$alignAtCenter]);
    ...
    var $Orasund$elm_layout$Layout$heading1 = F2(function (attrs, content) {
        return A2($elm$html$Html$h1, A2($elm$core$List$cons, A2($elm$html$Html$Attributes$style, 'display', 'flex'), attrs), _List_fromArray([content]));
    });
    ...
    var $author$project$View$settingsScreen = function (args) {
        return A2($Orasund$elm_layout$Layout$el, _Utils_ap($Orasund$elm_layout$Layout$centered, _List_fromArray([
            A2($elm$html$Html$Attributes$style, 'position', 'relative'),
            A2($elm$html$Html$Attributes$style, 'background-color', $author$project$Config$backgroundColor),
            A2($elm$html$Html$Attributes$style, 'color', $author$project$Config$lilyPadColor),
            A2($elm$html$Html$Attributes$style, 'height', $elm$core$String$fromFloat($author$project$Config$screenHeight) + 'px'),
            ...
            A2($Orasund$elm_layout$Layout$column, _List_fromArray([
                ...
                A2($Orasund$elm_layout$Layout$heading1, _List_fromArray([
                    A2($elm$html$Html$Attributes$style, 'color', $author$project$Config$playerColor)
                ...
                A2($elm$html$Html$input, _List_fromArray([
                    ...
                    $elm$html$Html$Attributes$value($elm$core$String$fromFloat(args.volume)),
                    $elm$html$Html$Events$onInput(function (string) {
                        return args.setVolume(A2($elm$core$Maybe$withDefault, 0, $elm$core$String$toFloat(string)));
                    })
                ]), _List_Nil),
                A2($Orasund$elm_layout$Layout$row, _List_fromArray([
                    $Orasund$elm_layout$Layout$gap(8)
                ]), _List_fromArray([
                    ...
                    A2($elm$html$Html$input, _List_fromArray([
                        ...
                        $elm$html$Html$Events$onInput(function (_v0) {
                            return args.mute;
                        })
                    ]), _List_Nil)
                ]))
    ...
    var $author$project$View$titleScreen = function (args) {
        return A2($Orasund$elm_layout$Layout$el, _Utils_ap($Orasund$elm_layout$Layout$centered, _List_fromArray([
            ...
            A2($Orasund$elm_layout$Layout$column, _List_fromArray([
                ...
                A2($Orasund$elm_layout$Layout$text, _List_fromArray([
                    A2($elm$html$Html$Attributes$style, 'color', $author$project$Config$lilyPadColor)
    ...
    var $author$project$Main$view = function (model) {
        return model.showSettings ? $author$project$View$settingsScreen({ close: $author$project$Main$ToggleSettings, isMute: model.isMuted, mute: $author$project$Main$ToggleMute, setVolume: $author$project$Main$SetVolume, volume: model.volume }) : (model.showTitle ? $author$project$View$titleScreen({ start: $author$project$Main$StartGame, toggleSettings: $author$project$Main$ToggleSettings }) : A2($author$project$View$fromGame, {
            onClick: $author$project$Main$ActivatePlatform,
            ratioToNextBeat: A2($author$project$Main$calcRatioToNextBeat, { msSinceLastBeat: model.msSinceLastBeat }, model.game),
